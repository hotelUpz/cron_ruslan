...
class UsersSettings():
    users_config = {
        "Ruslan": {                                  # -- имя пользователя
            "keys": {
                "BINANCE_API_PUBLIC_KEY": "7RYTtZ3QQT0GMcim7VtkaGm3P8hFRfsPbqUruHuL0Oku7tmCF3h4RUjWgM3UuHxR", # Rus
...
# --------- SYSTEM ----------------
USE_CACHE: bool = True                    # использовать кеш для восстановления позиции. При деплое на сервер можно отключить 
